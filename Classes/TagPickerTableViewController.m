//
//  TagPickerTableViewController.m
//  SocialCoder
//
...
@implementation TagPickerTableViewController
...
- (id)initWithRepository:(NSString *)repo  {
	...
	if(self)  {
		...
		tableData = [[NSMutableArray alloc] initWithObjects:
					 ...
					 [NSMutableArray array],
					 nil];
		[GitHubRepositoryServiceFactory requestTagsByName:repo 
...
- (void)gitHubService:(id <GitHubService>)gitHubService gotTag:(id <GitHubTag>)tag  {
	[[tableData objectAtIndex:0] addObject:tag];
